  ...
  return (
    <section className="shopping-cart">
      ...
      {shoppingCart.length === 0 && (
        <div className="shopping-cart__message-div center-content">
          Der Warenkorb{" "}
          <svg
      ...
      >
        {shoppingCart.map((article) => (
          <div className="shopping-cart__article-card">
            <div className="shopping-cart__img-name-div">
              <img src={article.img} className="shopping-cart__img" alt="" />
              <p className="shopping-cart__name ">{article.name}</p>
            </div>
